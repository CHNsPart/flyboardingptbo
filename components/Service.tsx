    ...
    <div className="bg-white py-6 sm:py-8 lg:py-12">
      <div className="mx-auto max-w-screen-lg px-4 md:px-8">
        ...
        <div className="mb-10 md:mb-16">
          <h2 className="mb-4 text-center text-4xl font-bold text-red-500 md:mb-6 lg:text-3xl">
            Our Plans
          </h2>
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-0">
          ...
          <div className="w-full rounded-lg bg-gray-800 p-6 sm:w-1/2 sm:rounded-r-none sm:p-8 lg:w-1/3">
            <div className="mb-4">
              ...
              <p className="text-gray-300">30 min Package</p>
            </div>

            <div className="mb-4 space-x-2">
              <span className="text-4xl font-bold text-gray-100">$150</span>
              <span className="text-2xl text-gray-300 line-through">$250</span>
            </div>
            ...
            <ul className="mb-6 space-y-2 text-gray-300">
              ...
              <li className="flex items-center gap-1.5">
                ...
                <span>Help From Professionals</span>
              </li>
              {/* feat - end */}
            </ul>
          ...
          {/* right side - start */}
          <div className="w-full rounded-lg bg-gradient-to-tr from-red-900 to-red-500 p-6 shadow-xl sm:w-1/2 sm:p-8">
            <div className="mb-4 flex flex-col items-start justify-between gap-4 lg:flex-row">
              <div>
                ...
                <p className="text-indigo-100">8 hour package</p>
              </div>
            ...
            <div className="mb-4 space-x-2">
              ...
              <span className="text-2xl text-indigo-100 line-through">$1999</span>
            </div>
